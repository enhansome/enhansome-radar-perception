# Awesome radar perception with stars
...
| Pointillism        | 2 TI AWR 1443                      | PC          | 3D bbox                          | [Github](https://github.com/Kshitizbansal/pointillism-multi-radar-data) ⭐ 17 \| 🐛 1 \| 🌐 Python \| 📅 2022-08-26 |
| Zendar SAR         | SAR                                | ADC, RD, PC | Pointwise Mask of Moving Vehicle | [Github](https://github.com/ZendarInc/ZendarSDK) ⚠️ Archived                                                       |
...
| aiMotive           | 77GHz LRR Radar x2(Front and Back) | PC          | 3D bbox, TrackID                 | [Website](https://github.com/aimotive/aimotive_dataset) ⭐ 53 \| 🐛 5 \| 📅 2023-09-26                              |
...
| TJ4DRadSet         | Oculii Eagle Long Range       | PC         | 3D bbox, TrackID                     | [Github](https://github.com/TJRadarLab/TJ4DRadSet) ⭐ 371 \| 🐛 4 \| 📅 2025-10-11                                                                         |
...
| Ghost                       | 77GHz long range \*2     | Ghost object detection                      | [Github](https://github.com/flkraus/ghosts) ⭐ 19 \| 🐛 0 \| 📅 2024-06-19                        |
...
| ODA                         | 24GHz                    | Obstacle detection and avoidance for drones | [Website](https://github.com/tudelft/ODA_Dataset) ⭐ 13 \| 🐛 0 \| 🌐 C++ \| 📅 2021-04-12        |
...
RadarSimPy: [Code](https://github.com/rookiepeng/radarsimpy) ⭐ 579 | 🐛 0 | 🌐 Python | 📅 2026-09-17;<br>
...
RaDICaL's Toolbox: [SDK](https://github.com/moodoki/radical_sdk) ⭐ 64 | 🐛 9 | 🌐 Jupyter Notebook | 📅 2024-03-31; <br>PyRapid: [SDK](http://radar.alizadeh.ca);<br>OpenRadar : [SDK](https://github.com/presenseradar/openradar) ⭐ 940 | 🐛 50 | 🌐 Jupyter Notebook | 📅 2024-04-30;<br>Pymmw: [SDK](https://github.com/m6c7l/pymmw) ⭐ 348 | 🐛 15 | 🌐 Python | 📅 2021-11-11;<br>Open radar initiative: [SDK](https://github.com/openradarinitiative);<br>RADIal's Emptyband-DDM Script: [Code](https://github.com/valeoai/RADIal/tree/main/SignalProcessing) ⭐ 262 | 🐛 37 | 🌐 Jupyter Notebook | 📅 2025-09-03
...
TI Radar and Camera in Python:[Code](https://github.com/yizhou-wang/cr-data-collector) ⭐ 28 | 🐛 0 | 🌐 Python | 📅 2021-03-26;<br>
Ainstein Radar ROS Node: [ROS Node](https://github.com/AinsteinAI/ainstein_radar) ⭐ 45 | 🐛 12 | 🌐 C++ | 📅 2024-04-08;<br>Continental ARS 408 ROS Node: [ROS Node](https://gitlab.com/ApexAI/autowareclass2020/-/tree/master/code/src/09_Perception_Radar/Radar-Hands-On-WS);<br>TI mmWave ROS Driver: [Guide](https://dev.ti.com/tirex/explore/node?node=ADINBw2NDaxb6JeW7V-lMQ__VLyFKFf__LATEST\&search=ROS);<br>RaDICaL's TI ROS Node: [ROS Node](https://github.com/moodoki/iwr_raw_rosnode) ⭐ 53 | 🐛 4 | 🌐 C | 📅 2021-03-17;<br>UoA's TI ROS Package: [ROS Node](https://github.com/radar-lab/ti_mmwave_rospkg) ⭐ 313 | 🐛 30 | 🌐 C++ | 📅 2024-03-01
...
* 2022-OpenCalib: A multi-sensor calibration toolbox for autonomous driving [Paper](https://arxiv.org/abs/2205.14087); [Code](https://github.com/PJLab-ADG/SensorsCalibration) ⭐ 3,225 | 🐛 145 | 🌐 C++ | 📅 2024-06-17
...
* 2022-A recurrent CNN for online object detection on raw radar frames\_\_`CARRADA`\_\_; **`ROD`**; [Paper](https://arxiv.org/abs/2212.11172)
...
* 2020-Depth Estimation from Monocular Images and Sparse Radar Data **`IROS`**; **`nuScenes`**; **`TwoStage`**; [Paper](https://ieeexplore.ieee.org/abstract/document/9340998);  [Code](https://github.com/brade31919/radar_depth) ⭐ 89 | 🐛 3 | 🌐 Python | 📅 2021-01-31
* 2021-Radar-Camera Pixel Depth Association for Depth Completion **`CVPR`**; **`nuScenes`**; **`MER`** ;  [Paper](https://openaccess.thecvf.com/content/CVPR2021/html/Long_Radar-Camera_Pixel_Depth_Association_for_Depth_Completion_CVPR_2021_paper.html); [Code](https://github.com/longyunf/rc-pda) ⭐ 60 | 🐛 9 | 🌐 Python | 📅 2021-07-15
* 2022-RVMDE: Radar Validated Monocular Depth Estimation for Robotics **`Arxiv`**; **`nuScenes`** [Paper](https://arxiv.org/abs/2109.05265); [Code](https://github.com/MI-Hussain/RVMDE) ⭐ 15 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2021-10-05
* 2021-Depth estimation from monocular images and sparse radar using deep ordinal regression network **`ICIP`**; **`nuScenes`**; **`DORN`** ; [Paper](https://ieeexplore.ieee.org/abstract/document/9506550); [Code](https://github.com/lochenchou/DORN) ⭐ 12 | 🐛 1 | 🌐 Python | 📅 2020-10-19
...
* 2020-milliEgo: Single-chip mmWave Aided Egomotion Estimation with Deep Sensor Fusion **`SenSys`**; [Paper](https://dl.acm.org/doi/abs/10.1145/3384419.3430776); [Code](https://github.com/ChristopherLu/milliEgo) ⭐ 62 | 🐛 3 | 🌐 Python | 📅 2022-10-06
...
* 2022-Self-Supervised Scene Flow Estimation with 4D Automotive Radar **`RAL`**; **`4DRadar`**; **`FlowNet`**; [Paper](https://arxiv.org/abs/2203.01137); [Code](https://github.com/Toytiny/RaFlow) ⭐ 79 | 🐛 0 | 🌐 Python | 📅 2023-03-18
* 2021-3D Radar Velocity Maps for Uncertain Dynamic Environments **`IROS`**; **`Bayesian`**; [Paper](https://ieeexplore.ieee.org/abstract/document/9636019); [Code](https://github.com/RansML/BDF) ⭐ 2 | 🐛 0 | 🌐 HTML | 📅 2021-03-28
...
* 2022-AutoPlace: Robust Place Recognition with Single-chip Automotive Radar **`ICRA`**; [Paper](https://ieeexplore.ieee.org/document/9811869); [Code](https://github.com/ramdrop/AutoPlace) ⭐ 112 | 🐛 3 | 🌐 Python | 📅 2022-04-06
...
* 2021-Do We Need to Compensate for Motion Distortion and Doppler Effects in Spinning Radar Navigation **`RAL`**; [Paper](https://ieeexplore.ieee.org/abstract/document/9327473); [Code](https://github.com/keenan-burnett/yeti_radar_odometry) ⭐ 153 | 🐛 1 | 🌐 C++ | 📅 2021-12-15
* 2022-Fast-MbyM: Leveraging Translational Invariance of the Fourier Transform for Efficient and Accurate Radar Odometry [Paper](https://ieeexplore.ieee.org/document/9812063) **`ICRA`**; [Code](https://github.com/applied-ai-lab/f-mbym) ⭐ 6 | 🐛 0 | 📅 2022-02-28
...
* 2021-The Radar Ghost Dataset – An Evaluation of Ghost Objects in Automotive Radar Data [Paper](https://ieeexplore.ieee.org/abstract/document/9636338); [Code](https://github.com/flkraus/ghosts) ⭐ 19 | 🐛 0 | 📅 2024-06-19
