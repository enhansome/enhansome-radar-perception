...
| K-Radar            | Macnica RETINA                | RAD        | 3D bbox, Track ID                    | [Github](https://github.com/kaist-avelab/K-Radar) ⭐ 600 \| 🐛 39 \| 🌐 Python \| 📅 2026-06-26; [OpenReview](https://openreview.net/forum?id=W_bsDmzwaZ7) |
...
RadarSimPy: [Code](https://github.com/rookiepeng/radarsimpy) ⭐ 576 | 🐛 0 | 🌐 Python | 📅 2026-09-10;<br>
...
* 2022-OpenCalib: A multi-sensor calibration toolbox for autonomous driving [Paper](https://arxiv.org/abs/2205.14087); [Code](https://github.com/PJLab-ADG/SensorsCalibration) ⭐ 3,216 | 🐛 145 | 🌐 C++ | 📅 2024-06-17
